...
Version  : 6.514
Release  : 21
URL      : https://cpan.metacpan.org/authors/id/M/ML/MLEHMANN/Coro-6.514.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/M/ML/MLEHMANN/Coro-6.514.tar.gz
Summary  : unknown
...
%prep
%setup -q -n Coro-6.514
cd %{_builddir}/Coro-6.514
...
cp %{_builddir}/Coro-6.514/Coro/libcoro/LICENSE %{buildroot}/usr/share/package-licenses/perl-Coro/40a2be7ced057c47d12a095fb029d4c19c790f5b
if test -f Makefile.PL; then
